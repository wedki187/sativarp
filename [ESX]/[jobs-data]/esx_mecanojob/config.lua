...
Config.Zones = {
  MecanoActions = {
    Pos   = { x = 809.6, y = -886.79, z = 24.25 }, -- -1.55 -1658.03 29.48
  ...
  Craft = {
    Pos   = { x = 839.6, y = -881.76, z = 24.25 },
    Size  = { x = 1.5, y = 1.0, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
