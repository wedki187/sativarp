...
function PrzebierzSzatnia(styl)
  ...
  elseif styl == 'ubranieM1' then
    SetPedComponentVariation(GetPlayerPed(-1), 8, 15, 1, 2)   -- PODKOSZULEK
    SetPedComponentVariation(GetPlayerPed(-1), 11, 242, 0, 2)  -- TOP
    SetPedComponentVariation(GetPlayerPed(-1), 0, 0, 0, 2)   -- RĘCE
    SetPedComponentVariation(GetPlayerPed(-1), 4, 101, 1, 2)   -- SPODNIE
    SetPedComponentVariation(GetPlayerPed(-1), 6, 8, 0, 1)   -- BUTY
