...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = 453.63,  y = -1017.6, z = 0},
			{x = 532.216,  y = -456.131, z = 0}
		}
	}
}
...
Config.CarGarageName = "Garaż SASP"
...
Config.HeliGarageName = "Helipad SASP"
...
Config.BoatGarageName = "Port SASP"
...
Config.ExtraGarageName = "Mechanika SASP"
...
Config.CarDraw3DText = "Wciśnij ~g~[E]~s~ aby wejść do~y~ garażu SASP~s~"			-- set your desired text here
...
Config.HeliDraw3DText = "Wciśnij ~g~[E]~s~ aby wejść do~y~ Helipadu SASP~s~"		-- set your desired text here
...
Config.BoatDraw3DText = "Wciśnij ~g~[E]~s~ aby wejść do~y~ portu SASP~s~"		-- set your desired text here
...
Config.ExtraDraw3DText = "Wciśnij ~g~[E]~s~ aby wejść do~y~ mechanika SASP~s~"		-- set your desired text here
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Zaparkuj pojazd"
Config.LabelGetVeh = "Pobierz pojazd"
Config.LabelPrimaryCol = "Pierwszy kolor"
Config.LabelSecondaryCol = "Drugi kolor"
Config.LabelExtra = "Dodatki"
Config.LabelLivery = "Malowanie"
Config.TitlePoliceGarage = "Garaż SASP"
Config.TitlePoliceExtra = "Dodatki"
Config.TitlePoliceLivery = "Malowanie"
Config.TitleColorType = "Kolor"
Config.TitleValues = "Wynik"

-- ESX.ShowNotifications:
Config.VehicleParked = "~b~Pojazd~s~ został zaparkowany!"
Config.NoVehicleNearby = "Brak ~b~pojazdu~s~ w pobliżu!"
Config.CarOutFromPolGar = "Wyjechałeś ~b~pojazdem~s~ z ~y~policyjnego garażu~s~!"
Config.HeliOutFromPolGar = "Pobrałeś helikopter"
Config.BoatOutFromPolGar = "Pobrałeś Łodź"
Config.VehRepNotify = "Twój pojazd jest naprawiany, poczekaj!"
Config.VehRepDoneNotify = "Twój pojazd został naprawiony"
Config.VehCleanNotify = "Twój pojazd jest myty, poczekaj!"
Config.VehCleanDoneNotify = "Twój ~b~pojazd~s~ został ~y~umyty~s~!"

-- ProgressBars text
Config.Progress1 = "NAPRAWIANIE SAMOCHODU"
Config.Progress2 = "CZYSZCZENIE SAMOCHODU"

-- ProgressBar Timers, in seconds:
Config.RepairTime = 5					-- time to repair vehicle
Config.CleanTime = 3.5					-- time to clean vehicle

Config.VehicleLoadText = "czekaj"			-- text on screen when vehicle model is being loaded
