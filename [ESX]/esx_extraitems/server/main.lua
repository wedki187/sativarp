...
ESX.RegisterUsableItem('dildo', function(source)
	TriggerClientEvent('esx_extraitems:dildo', source)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterUsableItem('makowiec', function(source)
	TriggerClientEvent('esx_extraitems:makowiec', source)
	local xPlayer = ESX.GetPlayerFromId(source)
	
	xPlayer.removeInventoryItem('makowiec', 1)
