...
local function HarvestMorf(source)
	...
	SetTimeout(Config.TimeToFarm, function()
		if PlayersHarvestingMorf[source] then
			...
			local morf = xPlayer.getInventoryItem('apple')
...
RegisterServerEvent('esx_morf:startHarvestMorf1')
AddEventHandler('esx_morf:startHarvestMorf1', function()
...
RegisterServerEvent('esx_morf:stopHarvestMorf1')
AddEventHandler('esx_morf:stopHarvestMorf1', function()
	local _source = source
...
RegisterServerEvent('esx_morf:stopTransformMorf1')
AddEventHandler('esx_morf:stopTransformMorf1', function()
	local _source = source
