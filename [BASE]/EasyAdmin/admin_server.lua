...
Citizen.CreateThread(function()
	...
	RegisterCommand("report", function(source, args, rawCommand)
		...
		for i,_ in pairs(OnlineAdmins) do 
			TriggerClientEvent('chatMessage', i, string.format(string.gsub(GetLocalisedText("playercalledforadmin"), "```", ""), getName(source), source, reason))
		end
		...
		DiscordHookReport('AriviRP.pl', wiadomosc, 11750815)
		TriggerClientEvent('chatMessage', source, "^1[SativaRP]", {255,255,255}, GetLocalisedText("admincalled"))
	
	end, false)

	function DiscordHookReport(hook,message,color)
		local gigafajnywebhook = 'https://discord.com/api/webhooks/804826946441052172/mYNBa5Z3nDFUV3aKEgTB-XVd5Iqq5OdKF6fDpuhP-Ftz_5MaWN5vXWTeV0eTKOjxcUi1'
		local embeds = {
					{
				["title"] = message,
				["type"] = "rich",
